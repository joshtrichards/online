...
void FillDocumentStructureBroker::sendStartMessage(const std::shared_ptr<ClientSession>& clientSession,
                                                const std::string& encodedFrom)
{
    ConvertToBroker::sendStartMessage(clientSession, encodedFrom);

    const auto command = "filldocumentstructure url=" + encodedFrom;
    forwardToChild(clientSession, command);
}
